    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.show_dialog_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(CameraFragmentActivity.this,
                        android.Manifest.permission.CAMERA)
                        != PackageManager.PERMISSION_GRANTED) {

                    if (ActivityCompat.shouldShowRequestPermissionRationale(CameraFragmentActivity.this,
                            android.Manifest.permission.CAMERA)) {
                    } else {
                        ActivityCompat.requestPermissions(CameraFragmentActivity.this,
